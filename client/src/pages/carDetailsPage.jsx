...
export default function CarDetails(){
    return(
            <div style={{backgroundImage: `url(${backGround})`,backgroundSize: "cover",backgroundPosition: "center",height: "200vh",width: "420px"}}>
                ...
                <h2 style={{color:"white",alignItems:"center",padding:"20px"}} >פרטי הרכב שלך </h2>
