...
import back from "../assets/icons/15755.png";

export default function CarDetails(){
    const user = JSON.parse(localStorage.getItem("user"));
    const carNumber = localStorage.getItem("userCarNumber");
    return(
            <div style={{backgroundImage: `url(${backGround})`,backgroundSize: "cover",minHeight: "150vh",width: "100%"}}>
                <div className="d-flex align-items-center flex-row justify-content-around"  style={{ backgroundColor: "#24292B", height: "70px"}}>                    
                    ...
                    <div>
                       <h5 style={{ color: "white" }}>ZEEKR X</h5>
                        <h6 className="text-white">מס' רכב: {user?.carNumber}</h6>
                    </div>
                    <img src={back} alt=""style={{ width: "40px", height: "40px" }}/>
                </div>  
                <div>
                ...
                <div className="container d-flex justify-content-center mt-5">
                    <div className="text-center d-flex flex-column align-items-center"style={{width: "100%",maxWidth: "360px",backgroundColor: "#24292B",borderRadius: "30px",padding: "20px",}}>
                        ...
                        <h6 style={{ color: "white" }}>{user?.carNumber} מס׳ רכב</h6>
                ...
                <div className="d-flex flex-column gap-3"style={{width: "100%",maxWidth: "800px",padding: "0 15px",alignItems: "center",}}>
                    <div className="d-flex flex-row gap-3" dir="rtl" >
