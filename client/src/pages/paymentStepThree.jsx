...
export default function PaymentStepThree(){
    return(
            <div style={{backgroundImage: `url(${backGround})`,backgroundSize: "cover",backgroundPosition: "center",height: "180vh",width: "420px",}}>
                ...
                <div className="d-flex" dir="rtl">
                    <div>
                        <img src={line} alt="" style={{position:"absolute",height:"840px",padding:"20px"}}/>
                        ...
                        <img src={ElipseTimeline} alt="" style={{position:"relative" ,left:"-10px", top:"220px"}}/>
                        <img src={ElipseTimeline} alt="" style={{position:"relative" ,left:"10px",top:"-20px"}}/>
                    </div>
                    <div >
                        <div style={{marginLeft:"20px",marginBottom:"30px",backgroundColor:"#24292B",borderRadius:"40px",textAlign:"right",height:"200px",width:"350px",padding:"30px",paddingRight:"10px"}}>
                        ...
                        <div style={{marginBottom:"30px",backgroundColor:"#24292B",borderRadius:"40px",textAlign:"right",height:"300px",width:"350px",padding:"30px",paddingRight:"10px"}}>
                            <h3 style={{color:"white",fontSize:"20px"}}>העלאת מסמך </h3>
                            <img src={Driver} alt="" />
                            <p style={{color:"white",fontSize:"20px"}}>כאן מעלים את טופס השיעבוד החתום שקיבלת בבנק או בגוף המממן.</p>
                            <div className="d-flex gap-3 justify-content-center" style={{height:"50px",width:"250px",border:"2px solid #FF5800",borderRadius:"20px"}}>
                                <img src={uplIcon} alt="" />
                                <h3 style={{color:"white",fontSize:"20px"}}>מסמך אישור מימון </h3>
                            </div>
                        </div>
                         <button style={{alignItems:"center",paddingLeft:"20px",margin:"30px",width:"200px",height:"35px",borderRadius:"33px",backgroundColor:"black",color:"#919495",border:"1px bold #919495"}}className="fw-bold">סיום התהליך</button>                           
                    </div>
                </div>
